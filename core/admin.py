...
from .models import CoachProfile, Match, Player, PlayerStatistic, TeamStatistic, Training, UserProfile
...
class MatchAdmin(admin.ModelAdmin):
    list_display = ("home_team", "away_team", "match_date", "match_time", "status")
