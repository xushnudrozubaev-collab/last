...
from .models import CoachProfile, Match, Player, PlayerStatistic, Training, TrainingAttendance, UserProfile
...
class RegisterSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        ...
        club_name = validated_data.pop("club_name", "") or "Murabbiy jamoasi"
...
class ReportRequestSerializer(serializers.Serializer):
    report_type = serializers.ChoiceField(choices=("player", "training", "month"))
